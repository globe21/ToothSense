...
/*
- (void)gradEmptyDataSet:(UIScrollView *)scrollView {
    CGRect frame = CGRectMake(CGRectGetMidX(scrollView.bounds), CGRectGetMidY(scrollView.bounds), CGRectGetWidth(scrollView.bounds), CGRectGetHeight(scrollView.bounds));
    ...
    UIColor *color = [UIColor colorWithRed:200 green:15 blue:15 alpha:1.0];
    UIColor *color2 = [UIColor colorWithRed:175 green:15 blue:15 alpha:1.0];
    UIColor *color3 = [UIColor colorWithRed:150 green:15 blue:15 alpha:1.0];
    gradientLayer.colors = @[color, color2, color3, color2, color];
    gradientLayer.startPoint = CGPointMake(minX, minY);
    gradientLayer.endPoint = CGPointMake(maxX, maxY);
        ...
        if (customView) {
            ...
            if (image) {
                if ([image respondsToSelector:@selector(imageWithRenderingMode:)]) {
                    ...
                    view.imageView.tintColor = [UIColor clearColor];
                    view.imageView.layer.cornerRadius = 8.0;
...
- (UIButton *)button
{
    if (!_button)
    {
        ...
        _button.layer.borderColor = [[UIColor colorWithRed:210.0f/255.0f green:56.11428f/255.0f blue:80.27196f/255.0f alpha:1.0f]CGColor];
