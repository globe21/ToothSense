...
//-------------------------------------------------------------------------------------------------------------------------------------------------
+ (void)show:(NSString *)status spincolor1:(UIColor *)spincolor1 backcolor1:(UIColor *)backcolor1  textcolor1:(UIColor *)textcolor1
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	[self shared].interaction = YES;
    [[self shared] hudMake:status image:nil spin:YES hide:NO spincolor1:spincolor1 backcolor1:backcolor1 textcolor1:textcolor1];     //hudMake:status image:nil spin:YES hide:NO spincolor:spincolor1 backcolor:backcolor1  textcolor:textcolor1];
}
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
- (void)hudMake:(NSString *)status image:(UIImage *)img spin:(BOOL)spin hide:(BOOL)hide spincolor1:(UIColor *)spincolor1 backcolor1:(UIColor *)backcolor1  textcolor1:(UIColor *)textcolor1
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
    _spincolor = spincolor1;
    _backcolor = backcolor1;
...
//-------------------------------------------------------------------------------------------------------------------------------------------------
{
	if (hud == nil)
	{
		...
		hud.translucent = YES;
        hud.backgroundColor = _backcolor;
	...
	if (hud.superview == nil)
	{
		if (interaction == NO)
		{
			...
			background.backgroundColor = _backcolor;
