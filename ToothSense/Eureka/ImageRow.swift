...
public class _ImageRow<Cell: CellType where Cell: BaseCell, Cell: TypedCellType, Cell.Value == UIImage>: SelectorRow<UIImage, Cell, ImagePickerController> {
    ...
    public override func customUpdateCell() {
        ...
        if let image = self.value {
            let imageView: PFImageView = PFImageView(frame: CGRectMake(0, 0, 80, 80))
            imageView.contentMode = .ScaleAspectFill
            imageView.image = image
            imageView.layer.cornerRadius = 40
            imageView.layer.borderWidth = 3.0
            imageView.layer.borderColor = AppConfiguration.navColor.CGColor
            imageView.tintColor = AppConfiguration.sideMenuText
...
public class _ImageRow<Cell: CellType where Cell: BaseCell, Cell: TypedCellType, Cell.Value == UIImage>: SelectorRow<UIImage, Cell, ImagePickerController> {
    ...
    public var imageView = UIImageView(frame: CGRectMake(0, 0, 80, 80))
    ...
    public override func customUpdateCell() {
        ...
        if let image = self.value {
            ...
            /*cell.contentView.addSubview(imageView)
             constrain(imageView, cell.contentView) { view1, view2 in
                view1.width   == 80
                view1.height  == 80
